      ...
      {rows.map((row) => (
        <Card key={row.id} className="space-y-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-500">{row.category_name}</p>
              <h3 className="mt-2 text-lg font-semibold text-slate-950">{row.source || 'Income entry'}</h3>
            </div>
