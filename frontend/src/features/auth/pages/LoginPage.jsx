        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <AuthInput
              ...
              icon="settings"
              rightAction={
                <button type="button" className="text-xs font-semibold text-[var(--text-muted)]" onClick={() => setShowPassword((current) => !current)}>
            ...
            <div className="flex items-center justify-between gap-4 text-sm">
              ...
              <button type="button" className="font-medium text-[var(--primary-600)]" onClick={() => notify({ tone: 'info', title: 'Forgot password', message: 'Password reset UI can be connected next without changing this screen.' })}>
                Forgot password?
              </button>
            </div>
          ...
          <div className="mt-6 flex items-center justify-between gap-4 text-sm text-[var(--text-muted)]">
            ...
            <Link to="/signup" className="font-semibold text-[var(--primary-600)]">Create one</Link>
          </div>
          <div className="mt-4">
